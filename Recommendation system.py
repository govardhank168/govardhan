...
import pandas as pd
#import Dataset 
#book = pd.read_csv("D:\\DS\\Assignments\\Assignments\\Recomendation Systems\\book.csv")
book = pd.read_csv('D:\\DS\\Assignments\\Assignments\\Recomendation Systems\\book.csv', encoding='latin-1')
book.shape #shape
book.columns
book.genre #genre columns
...
tfidf_matrix = tfidf.fit_transform(book.Book.Title)   #Transform a count matrix to a normalized tf or tf-idf representation
